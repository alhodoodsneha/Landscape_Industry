...
#
    ...
    def action_completed_inspection(self):
        ...
        design_team = self.env['design.team.member'].search([], limit=1)
        if not design_team:
    ...
    def action_completed_design(self):
        ...
        self.state = '1_done'
        self.crm_lead_id.quotation_type = 'waiting_for_estimation'
    ...
    def action_approve_estimation(self):
        ...
        self.crm_lead_id.quotation_type = 'quote_submitted'
